...
month.getSelectedIndex()==0||year.getSelectedIndex()==0||address.getText().equals("")||
 ...
 String sql="update users set NAME='"+name.getText()+"',DOB='"+day.getSelectedIndex()+"',DOB='"+month.getSelectedIndex()+"',DOB='"+year.getSelectedIndex()+"',ADDRESS='"+address.getText()+"',PHONE='"+phone.getText()+"',SALARY='"+salary.getText()+"' where ID= '"+id.getText()+"'";
try{
 pre=con.prepareStatement(sql);
 pre.execute();
